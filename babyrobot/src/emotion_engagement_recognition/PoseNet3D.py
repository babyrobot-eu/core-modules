...
class PoseNet3D(object):
    ...
    def _init_open_pose(self):
        ...
        weight_dict = dict()
        with open('/home/babyrobot/catkin_ws/src/engagement_emotion/scripts/weights/openpose-coco.pkl', 'rb') as fi:
    ...
    def _init_voxelposenet(self):
        ...
        if self.use_fast_vpn:
            checkpoint_path = '/home/babyrobot/catkin_ws/src/engagement_emotion/scripts/weights/snapshots_pose_run194/'
        else:
            checkpoint_path = '/home/babyrobot/catkin_ws/src/engagement_emotion/scripts/weights/snapshots_pose_run191/'
        rename_dict = {}
