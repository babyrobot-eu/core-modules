...
server_ip = '192.168.0.145' # ------------------- CHANGE THIS TO 145 for school
port = 1932
...
bridge = CvBridge()
rgb_sub = rospy.Subscriber('/kinect1/qhd/image_color', sensor_msgs.msg.Image, callback) # ------------------- CHANGE THIS TO kinect1 for school
print 'gjgfkjg'
