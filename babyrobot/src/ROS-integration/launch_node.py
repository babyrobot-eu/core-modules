...
def gesture_timing_handler():
    ...
    rospy.loginfo("Launch launcher node is connected and ready")
    ...
    while not rospy.is_shutdown():
        for line in readlines(sock):
            ...
            if line.startswith("EVENT athena.launch.launch"):
                read_next_line_and_run = True

            if line.startswith("EVENT athena.launch.stop"):
                try:
                    launch.shutdown()
                    launch = None
